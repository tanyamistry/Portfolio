...
import { CoefficientCombineRule, Collider, RigidBody } from "@dimforge/rapier3d-compat";
...
var RigidBody2 = (0, import_react.memo)((0, import_react.forwardRef)((props, forwardedRef) => {
  const {
    children,
    type,
    position,
...
RigidBody2.displayName = "RigidBody";
...
var InstancedRigidBodies = (0, import_react.memo)((0, import_react.forwardRef)((props, forwardedRef) => {
  ...
  }, children), instances === null || instances === void 0 ? void 0 : instances.map((instance, index) => import_react.default.createElement(RigidBody2, _extends({}, rigidBodyProps, instance, {
